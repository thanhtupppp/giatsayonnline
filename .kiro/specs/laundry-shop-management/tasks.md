...
- [ ] 1.1.1 Tạo React project với Vite hoặc Create React App
- [ ] 1.1.2 Cấu hình TypeScript cho type safety
- [ ] 1.1.3 Cài đặt và cấu hình ESLint + Prettier
- [ ] 1.1.4 Thiết lập Git repository và .gitignore
- [ ] 1.1.5 Tạo cấu trúc thư mục dự án (components, pages, services, utils, types)

### 1.2 Thiết Lập Firebase

- [ ] 1.2.1 Tạo Firebase project trên Firebase Console
- [ ] 1.2.2 Bật Firebase Authentication (Email/Password)
- [ ] 1.2.3 Tạo Firestore database (chế độ production)
- [ ] 1.2.4 Cài đặt Firebase SDK vào React project
- [ ] 1.2.5 Cấu hình Firebase config với environment variables
- [ ] 1.2.6 Tạo Firebase service wrapper (auth, firestore)

### 1.3 Thiết Lập Vercel Deployment

- [ ] 1.3.1 Kết nối Git repository với Vercel
- [ ] 1.3.2 Cấu hình environment variables trên Vercel
...
- [ ] 2.1.1 Viết Security Rules cho collection cuaHang
- [ ] 2.1.2 Viết Security Rules cho collection users với multi-tenant
- [ ] 2.1.3 Viết Security Rules cho collection donHang với data isolation
- [ ] 2.1.4 Viết Security Rules cho collection khachHang với maCuaHang filter
- [ ] 2.1.5 Viết Security Rules cho collection dichVu
- [ ] 2.1.6 Viết Security Rules cho collection giaoDich
- [ ] 2.1.7 Viết Security Rules cho collection cauHinhCuaHang
- [ ] 2.1.8 Viết Security Rules cho collection baoCao (immutable)
- [ ] 2.1.9 Viết Security Rules cho collection auditLog (immutable, Cloud Functions only)
...
- [ ] 2.3.1 Tạo composite index (maCuaHang, trangThai, ngayTao DESC) cho donHang
- [ ] 2.3.2 Tạo composite index (maCuaHang, maKhachHang, ngayTao DESC) cho donHang
- [ ] 2.3.3 Tạo composite index (maCuaHang, maNhanVien, ngayTao DESC) cho donHang
- [ ] 2.3.4 Tạo composite index (maCuaHang, daXacDinhDichVu, ngayTao DESC) cho donHang
- [ ] 2.3.5 Tạo composite index (maCuaHang, vaiTro, trangThai) cho users
- [ ] 2.3.6 Tạo unique index cho soDienThoai trong khachHang (per maCuaHang)
...
- [ ] 3.1.1 Tạo TypeScript interface CuaHang
- [ ] 3.1.2 Tạo service cuaHangService với CRUD operations
- [ ] 3.1.3 Implement tạo mã cửa hàng tự động (CH + 4 số)
- [ ] 3.1.4 Implement validation cho thông tin cửa hàng

### 3.2 UI Quản Lý Cửa Hàng (SUPER_ADMIN only)

- [ ] 3.2.1 Tạo trang danh sách cửa hàng
- [ ] 3.2.2 Tạo form tạo cửa hàng mới
- [ ] 3.2.3 Tạo form chỉnh sửa thông tin cửa hàng
- [ ] 3.2.4 Implement vô hiệu hóa/kích hoạt cửa hàng
...
- [ ] 4.1.1 Tạo TypeScript interface User với maCuaHang
- [ ] 4.1.2 Tạo enum VaiTro (SUPER_ADMIN, ADMIN, NHAN_VIEN_QUAY, KY_THUAT_VIEN)
- [ ] 4.1.3 Tạo userService với phân quyền multi-tenant
- [ ] 4.1.4 Implement đăng ký user mới với Custom Claims
- [ ] 4.1.5 Implement cập nhật vai trò user

### 4.2 Authentication UI

- [ ] 4.2.1 Tạo trang đăng nhập
- [ ] 4.2.2 Tạo trang đăng ký (chỉ cho SUPER_ADMIN/ADMIN)
- [ ] 4.2.3 Implement AuthContext với Custom Claims
- [ ] 4.2.4 Tạo ProtectedRoute component với role checking
- [ ] 4.2.5 Implement đăng xuất
- [ ] 4.2.6 Hiển thị thông tin user và vai trò trên header

### 4.3 UI Quản Lý Nhân Viên

- [ ] 4.3.1 Tạo trang danh sách nhân viên (filter theo maCuaHang)
- [ ] 4.3.2 Tạo form tạo nhân viên mới (ADMIN tạo cho cửa hàng mình)
- [ ] 4.3.3 Tạo form chỉnh sửa thông tin nhân viên
- [ ] 4.3.4 Implement vô hiệu hóa/kích hoạt nhân viên
- [ ] 4.3.5 Hiển thị vai trò và quyền hạn của nhân viên

## Giai Đoạn 5: Quản Lý Dịch Vụ

### 5.1 Model và Service cho Dịch Vụ

- [ ] 5.1.1 Tạo TypeScript interface DichVu với maCuaHang
- [ ] 5.1.2 Tạo enum LoaiTinhGia
- [ ] 5.1.3 Tạo dichVuService với CRUD operations (filter theo maCuaHang)
- [ ] 5.1.4 Implement tính giá dịch vụ theo loại (trọng lượng/số lượng/cố định)
- [ ] 5.1.5 Implement validation cho dịch vụ

### 5.2 UI Quản Lý Dịch Vụ

- [ ] 5.2.1 Tạo trang danh sách dịch vụ (filter theo maCuaHang)
- [ ] 5.2.2 Tạo form tạo dịch vụ mới
- [ ] 5.2.3 Tạo form chỉnh sửa dịch vụ
- [ ] 5.2.4 Implement vô hiệu hóa/kích hoạt dịch vụ
- [ ] 5.2.5 Hiển thị bảng giá và thời gian xử lý

## Giai Đoạn 6: Quản Lý Khách Hàng

### 6.1 Model và Service cho Khách Hàng

- [ ] 6.1.1 Tạo TypeScript interface KhachHang với maCuaHang
- [ ] 6.1.2 Tạo enum LoaiKhachHang
- [ ] 6.1.3 Tạo khachHangService với CRUD operations (filter theo maCuaHang)
- [ ] 6.1.4 Implement tìm kiếm khách hàng theo số điện thoại
- [ ] 6.1.5 Implement cập nhật điểm tích lũy và tổng chi tiêu
- [ ] 6.1.6 Implement tự động nâng cấp loại khách hàng

### 6.2 UI Quản Lý Khách Hàng

- [ ] 6.2.1 Tạo trang danh sách khách hàng (filter theo maCuaHang)
- [ ] 6.2.2 Tạo form tạo khách hàng nhanh (tên + SĐT)
- [ ] 6.2.3 Tạo form chỉnh sửa thông tin khách hàng
- [ ] 6.2.4 Hiển thị lịch sử giao dịch của khách hàng
- [ ] 6.2.5 Hiển thị điểm tích lũy và loại khách hàng

## Giai Đoạn 7: Cấu Hình Cửa Hàng (Settings)

### 7.1 Model và Service cho Cấu Hình

- [ ] 7.1.1 Tạo TypeScript interface CauHinhCuaHang
- [ ] 7.1.2 Tạo enum CheDoTaoDonHang (CHON_DICH_VU_TRUOC, CHON_DICH_VU_SAU)
- [ ] 7.1.3 Tạo cauHinhService với get/update operations
- [ ] 7.1.4 Implement load cấu hình khi user đăng nhập

### 7.2 UI Cấu Hình Cửa Hàng

- [ ] 7.2.1 Tạo trang Settings cho ADMIN
- [ ] 7.2.2 Tạo form chọn chế độ tạo đơn hàng
- [ ] 7.2.3 Tạo form cấu hình giờ mở cửa/đóng cửa
- [ ] 7.2.4 Tạo form cấu hình ngày nghỉ trong tuần
- [ ] 7.2.5 Tạo form cấu hình thông tin thanh toán
...
- [ ] 8.1.1 Tạo TypeScript interface DonHang với maCuaHang
- [ ] 8.1.2 Tạo enum TrangThaiDonHang
- [ ] 8.1.3 Tạo interface ChiTietDichVu
- [ ] 8.1.4 Tạo donHangService với CRUD operations (filter theo maCuaHang)
- [ ] 8.1.5 Implement tạo mã đơn hàng tự động (DH + YYYYMMDD + 4 số)
- [ ] 8.1.6 Implement tính tổng tiền đơn hàng
- [ ] 8.1.7 Implement tính ngày hẹn trả
- [ ] 8.1.8 Implement validation chuyển trạng thái

### 8.2 UI Tạo Đơn Hàng - Chế Độ 1

- [ ] 8.2.1 Tạo form tìm/tạo khách hàng (nhập SĐT)
- [ ] 8.2.2 Tạo grid chọn dịch vụ với hình ảnh
- [ ] 8.2.3 Tạo numpad nhập trọng lượng/số lượng
- [ ] 8.2.4 Tạo giỏ hàng hiển thị dịch vụ đã chọn
- [ ] 8.2.5 Hiển thị tổng tiền realtime
- [ ] 8.2.6 Implement xác nhận tạo đơn hàng
- [ ] 8.2.7 Tạo màn hình thanh toán
- [ ] 8.2.8 Implement in phiếu tiếp nhận với QR code

### 8.3 UI Quản Lý Đơn Hàng

- [ ] 8.3.1 Tạo trang danh sách đơn hàng (filter theo maCuaHang)
- [ ] 8.3.2 Tạo filter theo trạng thái, ngày tạo, khách hàng
- [ ] 8.3.3 Tạo trang chi tiết đơn hàng
- [ ] 8.3.4 Implement cập nhật trạng thái đơn hàng
- [ ] 8.3.5 Hiển thị lịch sử chuyển trạng thái
...
- [ ] 9.1.1 Implement tạo đơn hàng không có dịch vụ (tongTien = 0)
- [ ] 9.1.2 Implement cập nhật dịch vụ sau khi cân ký
- [ ] 9.1.3 Implement validation cho đơn hàng chế độ 2
- [ ] 9.1.4 Implement chuyển trạng thái CHO_CAN_KY
...
- [ ] 9.2.3 Implement in phiếu hẹn với QR code
- [ ] 9.2.4 Tạo màn hình quét QR code
...
- [ ] 10.1.1 Tạo layout POS với 3 cột (PC) / responsive (mobile)
- [ ] 10.1.2 Tạo section tìm kiếm khách hàng với autocomplete
- [ ] 10.1.3 Tạo grid dịch vụ với icon và giá
- [ ] 10.1.4 Tạo giỏ hàng với chức năng chỉnh sửa/xóa
...
- [ ] 10.1.8 Tối ưu cho màn hình cảm ứng (touch-friendly)

### 10.2 Chức Năng POS

- [ ] 10.2.1 Implement tạo đơn hàng nhanh từ POS
...
- [ ] 10.2.7 Implement reset màn hình sau hoàn tất
...
- [ ] 11.1.1 Tạo TypeScript interface GiaoDich với maCuaHang
- [ ] 11.1.2 Tạo enum PhuongThucThanhToan
- [ ] 11.1.3 Tạo enum TrangThaiGiaoDich
- [ ] 11.1.4 Tạo giaoDichService với CRUD operations (filter theo maCuaHang)
- [ ] 11.1.5 Implement tạo giao dịch với validation
- [ ] 11.1.6 Implement cập nhật đơn hàng sau thanh toán (transaction)
- [ ] 11.1.7 Implement hoàn tiền (giao dịch âm)

### 11.2 UI Thanh Toán

- [ ] 11.2.1 Tạo màn hình thanh toán với numpad
- [ ] 11.2.2 Hiển thị tổng tiền, đã trả, còn lại
- [ ] 11.2.3 Tạo nút chọn phương thức thanh toán
- [ ] 11.2.4 Implement nhập số tiền khách đưa
- [ ] 11.2.5 Hiển thị tiền thối tự động
- [ ] 11.2.6 Implement xác nhận thanh toán
...
- [ ] 12.1.1 Tạo TypeScript interface BaoCao với maCuaHang
...
- [ ] 12.1.4 Implement thống kê đơn hàng theo trạng thái
- [ ] 12.1.5 Implement thống kê dịch vụ phổ biến
- [ ] 12.1.6 Implement thống kê khách hàng (mới, thân thiết, VIP)
- [ ] 12.1.7 Implement lưu báo cáo vào Firestore (immutable)

### 12.2 UI Báo Cáo

- [ ] 12.2.1 Tạo trang báo cáo doanh thu (ADMIN xem cửa hàng mình, SUPER_ADMIN xem tất cả)
- [ ] 12.2.2 Tạo date picker chọn khoảng thời gian
- [ ] 12.2.3 Hiển thị biểu đồ doanh thu (chart.js hoặc recharts)
- [ ] 12.2.4 Hiển thị thống kê đơn hàng theo trạng thái
- [ ] 12.2.5 Hiển thị top dịch vụ phổ biến
- [ ] 12.2.6 Hiển thị thống kê khách hàng
...
- [ ] 13.2.1 Tạo trang xem audit log (ADMIN xem cửa hàng mình, SUPER_ADMIN xem tất cả)
- [ ] 13.2.2 Tạo filter theo userId, action, khoảng thời gian
...
- [ ] 14.1.1 Cài đặt thư viện QR code (qrcode.react)
- [ ] 14.1.2 Tạo template phiếu tiếp nhận
- [ ] 14.1.3 Tạo template phiếu hẹn (chế độ 2)
- [ ] 14.1.4 Tạo template hóa đơn
- [ ] 14.1.5 Implement tạo QR code chứa mã đơn hàng
- [ ] 14.1.6 Implement print preview
- [ ] 14.1.7 Implement print với window.print()
...
- [ ] 15.2.2 Hiển thị toast notification khi có cập nhật
...
- [ ] 17.1.1 Implement responsive grid với CSS Grid/Flexbox
- [ ] 17.1.2 Tạo breakpoints cho mobile, tablet, desktop
- [ ] 17.1.3 Optimize màn hình POS cho tablet
- [ ] 17.1.4 Implement hamburger menu cho mobile
...
- [ ] 18.1.1 Thiết lập theme colors (primary, secondary, success, error)
- [ ] 18.1.2 Implement dark mode và light mode
- [ ] 18.1.3 Tạo component library (Button, Input, Card, Modal)
- [ ] 18.1.4 Implement loading states và skeletons
- [ ] 18.1.5 Implement error states và empty states

### 18.2 User Experience

- [ ] 18.2.1 Implement toast notifications (success, error, warning)
- [ ] 18.2.2 Implement confirmation dialogs cho actions quan trọng
- [ ] 18.2.3 Implement autocomplete cho tìm kiếm
