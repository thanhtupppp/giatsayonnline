...
7. WHEN in phiếu tiếp nhận THEN Hệ*Thống SHALL tạo phiếu với barcode chứa Mã*Đơn_Hàng
8. WHEN Nhân_Viên quét barcode THEN Hệ_Thống SHALL tự động mở thông tin Đơn_Hàng
