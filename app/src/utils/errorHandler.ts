...
const FIRESTORE_ERROR_MAP: Record<string, string> = {
  ...
  'failed-precondition': 'Không thể thực hiện thao tác trong trạng thái hiện tại.',
...
function isVietnameseMessage(msg: string): boolean {
  ...
  return /[àáạảãâầấậẩẫăằắặẳẵèéẹẻẽêềếệểễìíịỉĩòóọỏõôồốộổỗơờớợởỡùúụủũưừứựửữỳýỵỷỹđ]/i.test(msg);
}
