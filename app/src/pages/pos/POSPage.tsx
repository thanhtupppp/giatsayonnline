          ...
          <Box sx={{ flex: 1, overflow: 'auto', minHeight: 0 }}>
            ...
            {!lookupOrder && pendingWashOrders.length > 0 && (
              <Card sx={{ mb: 2 }} className="scroll-wrapper">
                <CardContent sx={{ py: 1.5, '&:last-child': { pb: 1.5 }, px: 0 }}>
                    ...
                    {(() => {
                      ...
                      return pages.map((page, pageIdx) => (
                        <Box key={pageIdx} sx={{ 
                          ...
                          display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 1.5, px: 2, pb: 1 
                        }}>
                          {page.map(order => {
              ...
              <Card sx={{ mb: 2 }} className="scroll-wrapper">
                <CardContent sx={{ py: 1.5, '&:last-child': { pb: 1.5 }, px: 0 }}>
                  ...
                  <Box className="order-scroll-container" sx={{
                    ...
                    {(() => {
                      const pages = [];
                      for (let i = 0; i < pendingReturnOrders.length; i += 12) {
